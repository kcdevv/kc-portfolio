        ...
        <div className="grid md:grid-cols-12 gap-8 items-center">
          <div className="md:col-span-7 space-y-6">
            <div className="flex items-center">
              <div
                className="inline-block px-3 py-1 bg-accent dark:bg-accent/50 rounded-full text-sm font-medium text-primary animate-fade-in"
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold tracking-tight">
              <span
                ...
                style={{ animationDelay: "0.4s", display: "block" }}
              >
              ...
              <span
                ...
                style={{ animationDelay: "0.6s", display: "inline-block" }}
              >
            ...
            <p
              className="text-lg text-foreground/70 max-w-2xl animate-slide-right"
              style={{ animationDelay: "0.8s" }}
            >
              Passionate about building seamless digital experiences with modern
              technologies. Specialized in full-stack development, exploring
              Web3, and gaining insights into finance and investment
              applications.
            </p>

            <div
              className="flex flex-col sm:flex-row gap-4 pt-4 animate-slide-right"
