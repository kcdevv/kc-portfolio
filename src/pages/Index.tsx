      ...
      <section className="py-20 bg-accent/30">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {/* Card 1 */}
            <div
              className="glass-card rounded-xl p-6 hover:shadow-lg transition-all animate-fade-in"
            ...
            >
              ...
              <p className="text-muted-foreground">
                Developing decentralized applications and smart contracts for
            ...
            >
              ...
              <p className="text-muted-foreground">
                Exploring financial markets, investment strategies, and personal
                finance to build wealth and financial literacy.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="flex flex-col md:flex-row md:items-end justify-between mb-12">
            <div>
              ...
              <p className="text-lg text-muted-foreground max-w-2xl">
                Some of my recent work in web development, blockchain, and
                fintech
              </p>
            </div>
            <Link
